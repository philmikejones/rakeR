...
#' expand
#'
#' @param weights the matrix of integerised weights generated by
#' \code{rake() %>% trs()}.
#'
#' @return A matrix of integers with one column per zone.
#' These serve as indices to create the final simulated data frame.
#' @export
#'
#' @examples
#' # not run
